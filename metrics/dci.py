...
def _compute_dci(mus_train, ys_train, mus_test, ys_test):
    ...
    scores["dmetric/dci_informativeness_train"] = "{:.4f}".format(train_err)
    scores["dmetric/dci_informativeness_test"] = "{:.4f}".format(test_err)
    # scores["dmetric/dci_disentanglement"] = "{:.4f}".format(disentanglement(importance_matrix))
    # scores["dmetric/dci_completeness"] = "{:.4f}".format(completeness(importance_matrix))
