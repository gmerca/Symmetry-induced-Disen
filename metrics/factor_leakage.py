...
class FLMetric:
    ...
    def __call__(self, model):
        ...
        # return {
        #         'dmetric/factor_leakage_mean': "{:.4f}".format(self.fl_mean_fn(sorted_m, 1)),
        #         'dmetric/factor_leakage_norm_mean': "{:.4f}".format(self.fl_normalised_mean_fn(sorted_m, 1)),
        #         'dmetric/factor_leakage_auc': "{:.4f}".format(self.fl_auc_fn(sorted_m)),
        #         'dmetric/factor_leakage_nm_auc': "{:.4f}".format(self.fl_nm_auc_fn(sorted_m)),
        #         'dmetric/factor_leakage_list': self.fl_auc_list_fn(sorted_m)
        # }
        return self.fl_auc_fn(sorted_m)
